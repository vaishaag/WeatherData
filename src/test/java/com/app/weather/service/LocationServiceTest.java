...
public class LocationServiceTest {
	...
	public void testPopulateAllLocationDetails() throws Exception {
		...
		assertEquals(locations.get(0).getPosition().getElevation(), expectedList.get(0).getPosition().getElevation(),
				0);
		assertEquals(locations.get(0).getPosition().getLatitude(), expectedList.get(0).getPosition().getLatitude(), 0);
		assertEquals(locations.get(0).getPosition().getLongitude(), expectedList.get(0).getPosition().getLongitude(),
				0);
